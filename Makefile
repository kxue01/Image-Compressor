#COMP40 HW4 Arith Makefile (adapted from HW3 Makefile)
...
40image-6: quantvalues.o a2plain.o uarray2.o bitpack.o compress40.o unpack.o 40image.o constants.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

bitpack.o: bitpack.c constants.o
